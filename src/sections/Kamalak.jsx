...
const Kamalak = () => {
  ...
  useEffect(() => {
    ...
    fetch("/data/Data.json")
      .then((res) => res.json())
      .then((data) => setkamalak(data.kamalak))
          ...
          <div className="max-w-[832px] text-black font-normal leading-relaxed text-center 2xl:text-left">
            ...
            <div className="font-normal text-sm sm:text-base md:text-lg lg:text-xl flex flex-col gap-5 text-black">
              <p className="text-justify">
                Завод SAMARQAND KAMALAK INVEST TEKSTIL был основан в 2018 году и расположен в Самаркандской области, Узбекистан. Производственные мощности предприятия ориентированы на глубокую переработку хлопка и выпуск высококачественной пряжи. На прядильной фабрике установлено
                23 040 шпинделей, обеспечивающих стабильный процесс скручивания и производства пряжи. Годовой объём выпуска составляет около 8 000 тонн пряжи. <br />
                На предприятии трудятся более 600 специалистов, среди которых значительную часть составляют молодые квалифицированные кадры.
              </p>

              <p className="text-justify">
                Основная специализация завода — производство хлопчатобумажной пряжи:<br />
                • Carded (с прямым концом) — в диапазоне от Ne 6/1 до Ne 20/1;<br />
                • Open End (с открытым концом) — в диапазоне от Ne 6/1 до Ne 20/1;<br />
                • Slub — в диапазоне от Ne 6/1 до Ne 30/1;<br />
                • Lycra и Dual Core — в диапазоне от Ne 6/1 до Ne 20/1.<br />
              </p>
            </div>
